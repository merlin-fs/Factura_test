...
namespace Game.Client.Units
{
    ...
    {
        /// <summary>
        /// Стан блукання ворога. Рухається у випадковому напрямку зі змінами курсу,
        /// переходить у Chase при виявленні гравця або в Idle після закінчення часу.
        /// </summary>
